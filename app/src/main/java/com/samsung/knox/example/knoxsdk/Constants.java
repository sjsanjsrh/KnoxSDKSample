...
/**
 * Provide a valid development Knox Platform for Enterprise (KPE - Development) license as a constant. This technique is used for demonstration purposes
 * only.
...
public interface Constants {
    // TODO Enter the development EPE license key for Knox SDK. You can obtain it from https://seap.samsung.com/sdk.
    // TODO Implement a secure mechanism to pass the KPE key to your application
    String KPE_LICENSE_KEY = "KLM06-I0MPM-BECUH-71YLR-GCA3O-VRKGH";
}
